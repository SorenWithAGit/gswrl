...
# with pd.ExcelWriter(r"I:\USDA-ARS\Doug Smith\Riesel\Water Quaility\ISCO Raw\2021\2021_ISCO_Sampler_data.xlsx") as writer:
#     for sheet_name, dataframe in dataframes.items():
#         dataframe.to_excel(writer, sheet_name = sheet_name, index = False)


# iterate through dataframes and carry out calculations
for field, df in dataframes.items():
    ...
    print(storm_df[["Site", "Date", "Units", "# of Samples", "Start Volume", "End Volume", "Total Volume (ft3)", "Total Volume (mm)", \
                    "NO3-N [mg N/liter] smpl 1", "NO3-N [mg N/liter] smpl 2", "NO3-N [mg N/liter] avg"]])
